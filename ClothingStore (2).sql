...
--
-- Хост: 127.0.0.1:3307
-- Время создания: Апр 29 2026 г., 13:38
...
INSERT INTO `Orders` (`id_order`, `id_user`, `id_adress`, `price`, `data_order`, `arrival_data`, `pay_method`, `status`) VALUES
(1, 28, 1, 24624, '2026-04-29 10:37:48', '1231-03-12', 'СБП', 'Новый');
...
(28, 'ramazanikbaev6@gmail.com', 'ramazanikbaev6@gmail.com', NULL, 'Активен', NULL, NULL, NULL);
...
ALTER TABLE `Orders`
  ...
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`id_adress`) REFERENCES `Addresses` (`id_address`);
