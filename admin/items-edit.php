...
<body>
    ...
    <div class="container d-flex mx-auto mt-3">
        <div class="item-card" style="animation: show 0.15s ease-in;">
                        <div class="item-card">
            ...
            <form method="post" action="items-db.php" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-control" id="category" name="category" type="text" required value="<?= $item[5] ?>">
                        <? foreach ($categories as $category): ?>
                            <option value="<?= $category[0] ?>" <?= $item[6] == $category[0] ? "selected" : "" ?>><?= $category[1] ?>
                            </option>
                        <? endforeach; ?>
                    </select>
                </div>
                <div class="mb-3">
                    ...
                    <select class="form-control" id="category" name="status" type="text" required value="<?= $item[5] ?>">
                        <option value="Доступен" <?= $item[5] == "Доступен" ? "selected" : "" ?>>Доступен</option>
                        <option value="Не доступен" <?= $item[5] == "Не доступен" ? "selected" : "" ?>>Не доступен</option>
                    </select>
                </div>
