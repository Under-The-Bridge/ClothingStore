        ...
        <div id="profilePanel">
            ...
            <div id="profile">
                <div id="Kabinet">
                    ...
                    <a class="KabinetBtn selected" href="editprofile.php">
                ...
                <form action="../profile-db.php" method="POST">
                    <div id="data">
                        ...
                        <div>
                            ...
                            <div class="input-group has-validation">
                                <div class="form-floating is-invalid">
                                    <input type="text" class="form-control" id="floatingInputGroup2" placeholder="Username" name="surnameForm" value="<?=$user["surname"]?>">
                            ...
                            <div class="input-group has-validation">
                                <div class="form-floating is-invalid">
                                    <input type="text" class="form-control" id="floatingInputGroup2"
                                        placeholder="Username" name="patronymicForm" value="<?=$user["patronymic"]?>">
                                    <label for="floatingInputGroup2">Отчество:</label>
                                </div>
                            </div>
                            <div class="input-group has-validation">
                                <div class="form-floating is-invalid">
                            ...
                            <div class="input-group has-validation">
                                <div class="form-floating is-invalid">
                                    <input type="tel" class="form-control" id="floatingInputGroup2"
                                        placeholder="Username" name="phoneForm" value="<?=$user["phone"]?>">
                                    <label for="floatingInputGroup2">Номер телефона:</label>
                                </div>
                            </div>
                        </div>
                        <button name="btnSave" style="width: 200px;" class="btn-black">Сохранить</button>
                        <button name="btnDelete" style="width: 200px;" class="btn-black">Удалить профиль</button>
                        <button name="btnExit" style="width: 200px;" class="btn-black">Выйти</button>
                    </div>
                </form>
            </div>
        </div>
