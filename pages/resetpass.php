    ...
    <main>
        <div id="container">
            ...
            <div id="forms-elem">
                <h1>АККАУНТ</h1>
                <div id="forms">
                    <form action="../resetpass-db.php" method="POST" style="width:100%">
                        <input name="email" hidden value="<?=$_GET["email"]?>">
                        <h3>Восстановления пароля</h3>
                        <div class="input-group has-validation">
                            <div class="form-floating is-invalid">
                                <input name="password" type="password" class="form-control" id="floatingInputGroup2"
                        ...
                        <div class="input-group has-validation">
                            <div class="form-floating is-invalid">
                                <input name="passwordCheck" type="password" class="form-control" id="floatingInputGroup2"
                                    placeholder="Username" required>
