        ...
        <div id="profilePanel">
            ...
            <div id="profile">
                <div id="Kabinet">
                    ...
                    <a class="KabinetBtn selected" href="password.php">
                            ...
                            <div class="input-group has-validation">
                                <div class="form-floating is-invalid">
                                    <input type="text" class="form-control" id="floatingInputGroup2"
                                        placeholder="Username" name="oldPass">
                                    <label for="floatingInputGroup2">Старый пароль:</label>
                                </div>
                            </div>
                            <div class="input-group has-validation">
                                <div class="form-floating is-invalid">
                                    <input type="text" class="form-control" id="floatingInputGroup2"
                                        placeholder="Username" name="newPass">
                                    <label for="floatingInputGroup2">Новый пароль:</label>
                                </div>
                            </div>
                        </div>
                        <button name="btnPass" style="width: 200px;" class="btn-black">Изменить</button>
                    </div>
                </form>
            </div>
        </div>
